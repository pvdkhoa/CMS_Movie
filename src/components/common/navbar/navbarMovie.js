  ...
  return (
    <div className=" border-b-[1px] border-gray-400 w-full flex pb-2  justify-between items-end font font-MonaSans ">
      ...
      <div className="flex gap-4">
        ...
        {props.activeItem ? (
          <Button icon={<UserOutlined />} iconPosition={position} onClick={props.toggleActor} >
            Actor
          </Button>
        ) : (
        ...
        {props.activeItem ? (<Button icon={<BookOutlined />} iconPosition={position}>
            Episode
          </Button>) : (<Button icon={<BookOutlined />} iconPosition={position} disabled>
            Episode
          </Button>)}
